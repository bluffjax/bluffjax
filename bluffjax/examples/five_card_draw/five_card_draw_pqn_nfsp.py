"""
PQN + NFSP for Five-Card-Draw (AEC).
"""
...
def main(config: dict) -> None:
    ...
    if config["save_final"]:
        ...
        br_save_path = os.path.join(
            config["save_dir"], f"five_card_draw_pqn_nfsp_br_{timestamp}.msgpack"
        )
        avg_save_path = os.path.join(
            config["save_dir"], f"five_card_draw_pqn_nfsp_avg_{timestamp}.msgpack"
        )
